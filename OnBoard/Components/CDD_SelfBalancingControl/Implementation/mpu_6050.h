...
void MPU6050_Get6AxisRawData(Mpu_6050_Type *mpu6050);
int MPU6050_DataReady(void);
void MPU6050_Get_LSB_Sensitivity(uint8_t FS_SCALE_GYRO, uint8_t FS_SCALE_ACC);
void MPU6050_DataConvert(Mpu_6050_Type *mpu6050);
void MPU6050_ProcessData(Mpu_6050_Type *mpu6050);
