...
#define FTM_PWM_IP_SW_MAJOR_VERSION                3
...
extern Ftm_Pwm_Ip_ReloadCallbackCfgType  Ftm_Pwm_Ip_pReloadIrqCallback[FTM_PWM_IP_INSTANCE_COUNT];
#endif

/*! @brief Arrays to store the state of each instance */
extern Ftm_Pwm_Ip_ChannelStateType Ftm_Pwm_Ip_aInstanceState[FTM_PWM_IP_INSTANCE_COUNT];
...
extern Ftm_Pwm_Ip_CallbackCfgType Ftm_Pwm_Ip_pOverflowIrqCallback[FTM_PWM_IP_INSTANCE_COUNT];

#if (FTM_PWM_IP_NOTIFICATION_SUPPORTED == STD_OFF)
/*! @brief Arrays for irq channel notifications of each channel*/
extern Ftm_Pwm_Ip_CallbackCfgType  Ftm_Pwm_Ip_aChIrqCallbacks[FTM_PWM_IP_INSTANCE_COUNT][FTM_PWM_IP_CHANNEL_IRQ_COUNT];
#endif
