...
* @details          Parameters used when raising an error/exception
*/
#define PWM_FASTUPDATEDUTYCYCLE_ID                  (0x36U)
/**
...
/**
* @brief        This function force channels output to their inactive state (as immediate or synchronized base on API parameter UpdateType).
