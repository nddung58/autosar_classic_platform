...
#ifdef ADC_DMA_SUPPORTED
/* Check if Adc_Ipw_PBcfg.c file and Dma_Ip_Cfg.h file are of the same Autosar version */
#if ((ADC_IPW_AR_RELEASE_MAJOR_VERSION_PBCFG_C != DMA_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ADC_IPW_AR_RELEASE_MINOR_VERSION_PBCFG_C != DMA_IP_CFG_AR_RELEASE_MINOR_VERSION) \
    )
    #error "AutoSar Version Numbers of Adc_Ipw_PBcfg.c and Dma_Ip_Cfg.h are different"
#endif
#endif /* ADC_DMA_SUPPORTED */
...
const Adc_Ipw_Config AdcIpwCfg =
{
    ...
    /* Mapping */
    {
        ...
        { 3U, 0U }, /* AdcChannels */
        { DMA_LOGIC_CH_1, ADC_IPW_INVALID_DMA_CHANNEL_ID }, /* AdcDmaChannelLogicId */
