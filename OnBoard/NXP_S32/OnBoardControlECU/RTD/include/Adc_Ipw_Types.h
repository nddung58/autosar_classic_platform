...
#if (STD_ON == ADC_ENABLE_READ_RAW_DATA_API)
/**
...
*/
    ...
    #define ADC_IPW_MAX_CHN_ID      (ADC_IP_INPUTCHAN_SUPPLY_VDD_LV_VAL)
#elif (FEATURE_ADC_MAX_EXT_CHAN_ID <= 15u)
    #define ADC_IPW_MAX_CHN_ID      (ADC_IP_INPUTCHAN_VREFL_VAL)
#elif (FEATURE_ADC_MAX_EXT_CHAN_ID <= 23u)
    #define ADC_IPW_MAX_CHN_ID      (ADC_IP_INPUTCHAN_EXT23_VAL)
#else
    #define ADC_IPW_MAX_CHN_ID      (ADC_IP_INPUTCHAN_EXT31_VAL)
