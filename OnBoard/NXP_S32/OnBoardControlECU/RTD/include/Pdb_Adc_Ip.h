...
#define PDB_ADC_IP_SW_MAJOR_VERSION               3
...
/*!
 * @brief Enable PDB delay interrupt
 *
 * This function enables PDB delay interrupt mode
 *
 * @param[in] Instance - PDB instance number
 */
...
/*!
 * @brief Disable PDB delay interrupt
 *
 * This function disables PDB delay interrupt mode
 *
 * @param[in] Instance - PDB instance number
 */
...
/*!
 * @brief Get PDB delay interrupt state
 *
 * This function checks if PDB delay interrupt was enabled
 *
 * @param[in] Instance - PDB instance number
 */
