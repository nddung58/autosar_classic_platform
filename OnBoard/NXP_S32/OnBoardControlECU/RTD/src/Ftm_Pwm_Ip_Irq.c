...
#define FTM_PWM_IP_IRQ_SW_MAJOR_VERSION_C               3
...
#if (FTM_PWM_IP_IRQ_VENDOR_ID_C != FTM_PWM_IP_VENDOR_ID)
    #error "Vendor IDs of Ftm_Pwm_Ip_Irq.c and Ftm_Pwm_Ip.h are different."
#endif

/* Check if source file and Ftm_Pwm_Ip.h header file are of the same AUTOSAR version */
#if ((FTM_PWM_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C    != FTM_PWM_IP_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_PWM_IP_IRQ_AR_RELEASE_MINOR_VERSION_C    != FTM_PWM_IP_AR_RELEASE_MINOR_VERSION) || \
     (FTM_PWM_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != FTM_PWM_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR version numbers of Ftm_Pwm_Ip_Irq.c and Ftm_Pwm_Ip.h are different."
#endif

/* Check if header file and Ftm_Pwm_Ip.h header file are of the same software version */
#if ((FTM_PWM_IP_IRQ_SW_MAJOR_VERSION_C != FTM_PWM_IP_SW_MAJOR_VERSION) || \
     (FTM_PWM_IP_IRQ_SW_MINOR_VERSION_C != FTM_PWM_IP_SW_MINOR_VERSION) || \
     (FTM_PWM_IP_IRQ_SW_PATCH_VERSION_C != FTM_PWM_IP_SW_PATCH_VERSION))
    #error "Software version numbers of Ftm_Pwm_Ip_Irq.c and Ftm_Pwm_Ip.h are different."
#endif
...
static void Ftm_Pwm_Ip_ProcessValidTofInterrupt(uint8 Instance);
static void Ftm_Pwm_Ip_ProcessTofInterrupt(uint8 Instance);
     ...
     || (defined FTM_PWM_IP_0_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_1_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_2_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_3_OVF_RELOAD_ISR_USED) \
     || (defined FTM_PWM_IP_4_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_5_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_6_OVF_RELOAD_ISR_USED) || (defined FTM_PWM_IP_7_OVF_RELOAD_ISR_USED) \
     || (defined FTM_PWM_IP_0_RELOAD_ISR_USED) || (defined FTM_PWM_IP_1_RELOAD_ISR_USED) || (defined FTM_PWM_IP_2_RELOAD_ISR_USED) || (defined FTM_PWM_IP_3_RELOAD_ISR_USED))
...
static void Ftm_Pwm_Ip_ProcessValidCommonInterrupt(uint8 Instance, uint8 HwChannel);
...
/**
 *
 * Function Name : Ftm_Pwm_Ip_ProcessValidTofInterrupt
 * Description   : Process a timer overflow interrupt event when it's a valid interrupt
 *
 **/
static void Ftm_Pwm_Ip_ProcessValidTofInterrupt(uint8 Instance)
{
...
static void Ftm_Pwm_Ip_ProcessTofInterrupt(uint8 Instance)
{
    ...
    else
    {
        ...
        {
            Ftm_Pwm_Ip_ProcessValidTofInterrupt(Instance);
        }
    }
}
#endif
...
/**
 *
 * Function Name : Ftm_Pwm_Ip_ProcessValidCommonInterrupt
 * Description   : Process a channel interrupt event when it is a valid interrupt
 *
 **/
static void Ftm_Pwm_Ip_ProcessValidCommonInterrupt(uint8 Instance, uint8 HwChannel)
{
...
static void Ftm_Pwm_Ip_ProcessCommonInterrupt(uint8 Instance, uint8 HwChannel)
{
    ...
    else
    {
        ...
        {
            Ftm_Pwm_Ip_ProcessValidCommonInterrupt(Instance, HwChannel);
        }
    }
}
#endif
 ...
 * Function Name : Ftm_Pwm_Ip_ProcessReloadInterrupt
 * Description   :
 * @implements Ftm_Pwm_Ip_ProcessFaultInterrupt_Activity
 **/
static void Ftm_Pwm_Ip_ProcessFaultInterrupt(uint8 Instance, uint8 FaultId)
{
    Ftm_Pwm_Ip_HwAddrType * FtmBase = Ftm_Pwm_Ip_aFtmBase[Instance];
