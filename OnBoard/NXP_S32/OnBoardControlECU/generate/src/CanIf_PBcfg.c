...
static const CanIf_TxPduType CanIf_TxPdu[10U] =
{
    {
        /* .PduIdType */
        (uint8)0U,
...
static const CanIf_RxPduType CanIf_RxPdu[4U] =
{
    {
        /* .PduId */
        (uint8)0U,
...
static const CanIf_RxPduType * const CanIf_Can_43_FLEXCAN_HohToRxPduMapping[11U] = 
{
    &CanIf_RxPdu[0U],
    &CanIf_RxPdu[1U],
    &CanIf_RxPdu[2U],
