...
*/
#define CAN_43_FLEXCAN_HWOBJECT_CONFIG_COUNT    ((Can_HwHandleType)11U)
...
#define Can_43_FLEXCANConf_CanHardwareObject_CanHardwareObject_Tx0    ((Can_HwHandleType)10U)
/**
