...
*
*/
#define PwmChannel_LedRed                            ((Pwm_ChannelType)0U)
#define PwmChannel_Motor1                            ((Pwm_ChannelType)1U)
#define PwmChannel_Motor2                            ((Pwm_ChannelType)2U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannel_PwmChannel_LedRed          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannel_PwmChannel_Motor1          ((Pwm_ChannelType)1U)
#define PwmConf_PwmChannel_PwmChannel_Motor2          ((Pwm_ChannelType)2U)
